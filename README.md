...
[![Launch on Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/GLAM-Workbench/nara/master/?urlpath=lab/tree/index.md)
...
[![Launch on Reclaim Cloud](https://glam-workbench.github.io/images/launch-on-reclaim-cloud.svg)](https://app.my.reclaim.cloud/?manifest=https://raw.githubusercontent.com/GLAM-Workbench/nara/master/reclaim-manifest.jps)
...
* From the command line, run the following command:  
  ```
  docker run -p 8888:8888 --name nara -v "$PWD":/home/jovyan/work quay.io/glamworkbench/nara repo2docker-entrypoint jupyter lab --ip 0.0.0.0 --NotebookApp.token='' --LabApp.default_url='/lab/tree/index.ipynb'
  ```
...
* Create a virtual environment, eg: `python -m venv nara`
* Open the new directory" `cd nara`
* Activate the environment `source bin/activate`
* Clone the repository: `git clone https://github.com/GLAM-Workbench/nara.git notebooks`
